 ...
 * 2019-02-20T14:52:48.202+08:00
 * Generated source version: 3.3.0
 *
 */
@WebServiceClient(name = "UserServiceImplService",
                  wsdlLocation = "http://localhost:8080/web_service_spring_s/userService/userService?wsdl",
                  targetNamespace = "http://impl.service.www.lct.com/")
public class UserServiceImplService extends Service {

    public final static URL WSDL_LOCATION;

    public final static QName SERVICE = new QName("http://impl.service.www.lct.com/", "UserServiceImplService");
    public final static QName UserServiceImplPort = new QName("http://impl.service.www.lct.com/", "UserServiceImplPort");
    static {
        URL url = null;
        try {
            url = new URL("http://localhost:8080/web_service_spring_s/userService/userService?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(UserServiceImplService.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "http://localhost:8080/web_service_spring_s/userService/userService?wsdl");
        }
        WSDL_LOCATION = url;
    }
